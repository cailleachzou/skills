...
> **Windows Python Path Fix**: On this machine, use `/c/Users/59620/AppData/Local/Python/bin/python.exe` instead of bare `python` command to avoid Windows Store redirect issues.
...
### Step 1: Extract Text and Generate Review Prompt
...
### Step 2: Export PDF Page as Image
...
for i, page in enumerate(pdf):
    bitmap = page.render(scale=2.0)  # 2x scale ≈ 144 DPI，适合视觉 AI
    img = bitmap.to_pil()
