# Claude Code Skills 学习资料

> 本目录包含 Claude Code Skills 库的学习资料，帮助你快速掌握 38 个技能的使用方法。
...
└── prompts/                     # 提示词部分
    └── self-assessment.md       # 渐进式自测提示词（可直接粘贴到 Claude Code）
```
...
| 来源 | 数量 | 说明 |
|------|------|------|
| 自建技能 | 17 | 项目专用：文档、图表、CAD、文档解析、搜索等 |
| 插件技能 | 21 | 通用能力：开发工作流、Obsidian、前端设计等 |
| **合计** | **38** | |
